...
public:
    sim_thread(uint32_t thread_index,
               ...
               std::shared_ptr<barrier> sync_barrier,
               bool &global_drained,
...
public:
    ...
    virtual ~sim();
private:
    vector<std::shared_ptr<sim_thread> > sim_threads;
